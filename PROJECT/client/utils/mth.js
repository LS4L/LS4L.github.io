...
export class vec3 {
  ...
  div(n) {
    return n != 0 ? new vec3(this.x / n, this.y / n, this.z / n) : new vec3();
  }
  neg() {
  ...
  mulMatr(m) {
    ...
    return new vec3(
      (this.x * m[0][0] + this.y * m[1][0] + this.z * m[2][0] + m[3][0]) / w,
...
export class vec4 {
  ...
  dot(vec) {
    return this.x * vec.x + this.y * vec.y + this.z * vec.z + this.w * this.w;
  }
  len2() {
    return (
